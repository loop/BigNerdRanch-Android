...
/**
 * Created by yogesh on 29/08/2014.
 */
public class RemoteControlFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        enterButton.setTextAppearance(getActivity(), R.style.RemoteButton_Actions);
        deleteButton.setTextAppearance(getActivity(), R.style.RemoteButton_Actions);
