...
/**
 * Created by yogesh on 22/08/2014.
 */
public class CrimeCameraFragment extends Fragment {
    private static final String TAG = "CrimeCameraFragment";

    public static final String EXTRA_PHOTO_FILENAME = "com.yogeshn.criminalintent.photo_filename";
    public static final String EXTRA_PHOTO_ORIENTATION = "com.yogeshn.criminalintent.photo_oreintation";
    ...
    private Camera.Size getBestSupportedSize(List<Size> sizes, int width, int height) {
