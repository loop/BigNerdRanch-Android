...
public class PollService extends IntentService {
    ...
    public static final String ACTION_SHOW_NOTIFICATION = "com.yogeshn.photogallery.SHOW_NOTIFICATION";
    public static final String PERM_PRIVATE = "com.yogeshn.photogallery.PRIVATE";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        boolean isNetworkingAvilable =  cm.getActiveNetworkInfo() != null;

        if (!isNetworkingAvilable) {
            return;
        }
        ...
        Log.i(TAG, "Recieve an intent: " + intent);
    }
